...
//  EmojiReader
//
//  Created by Ekaterina Yashunina on 25.04.2022.
//
...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        ...
        Emoji(emoji: "🎾", name: "Tennis", description: "Let's play tennis together", isFavourite: false),
        Emoji(emoji: "🐱", name: "Kitten", description: "Kitten is the cutest animal", isFavourite: false)
    ]
